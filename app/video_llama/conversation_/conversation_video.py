...
from video_llama.processors.video_processor import load_video, load_video_all_frames
...
class Chat:
    ...
    def upload_video(self, video_path, conv, img_list):
        ...
        try:
            ...
            if audio_flag == 1:
                ...
                conv.append_message(
                    conv.roles[0],
                    "Close your eyes, open your ears and you imagine only based on the sound that: <ImageHere>. \
    ...
    def get_context_emb(self, conv, img_list):
        ...
        mixed_embs = [emb for pair in zip(seg_embs[:-1], img_list, strict=False) for emb in pair] + [seg_embs[-1]]
