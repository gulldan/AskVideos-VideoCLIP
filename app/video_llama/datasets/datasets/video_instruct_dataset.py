        ...
        for _ in range(num_retries):
            ...
            try:
                ...
                if self.model_type == "vicuna":
                    ...
                    raise ("not support")
                # print('Preprocessed')
                data_dict = dict(input_ids=data_dict["input_ids"][0], texts=data_dict["texts"][0], labels=data_dict["labels"][0])
...
def _tokenize_fn(strings: Sequence[str], tokenizer: transformers.PreTrainedTokenizer) -> dict:
    ...
    return dict(input_ids=input_ids, labels=labels, input_ids_lens=input_ids_lens, labels_lens=labels_lens, texts=texts)
